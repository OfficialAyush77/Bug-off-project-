    ...
    <header>
      ...
      <div className="flex items-center bg-black p-1 flex-grow py-2">
        ...
        <div className="hidden sm:flex items-center h-10 w-10 rounded-md flex-grow cursor-pointer bg-pink-400 hover:bg-green-500">
          <input
            className="p- h-full width-2  flex-shrink rounded-l-md focus:outline-none px-100 "
            type="text"
          />
        ...
        <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
          ...
          <div className="relative link flex items-center">
            <span className="fixed top-0 right-10 md:right-7 h-4 w-4 bg-yellow-100 text-center rounded-full text-black font-bold">
              0
            </span>
